...
$query_loginform = "SELECT * FROM users UNION  SELECT * FROM register";
$loginform = mysql_query($query_loginform, $estatemgtdb) or die(mysql_error());
$row_loginform = mysql_fetch_assoc($loginform);
$totalRows_loginform = mysql_num_rows($loginform);
$query_loginform = "SELECT * FROM users";
$loginform = mysql_query($query_loginform, $estatemgtdb) or die(mysql_error());
$row_loginform = mysql_fetch_assoc($loginform);
$totalRows_loginform = mysql_num_rows($loginform);
?>
...
if (isset($_POST['Username'])) {
  ...
  $LoginRS = mysql_query($LoginRS__query, $estatemgtdb) or die(mysql_error());
