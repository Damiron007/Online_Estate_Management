...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO building_charge (id, property_id, Surname, Firstname, `Phone Number`, `Cost (Naira)`, `primary key`) VALUES (%s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['id'], "int"),
                       GetSQLValueString($_POST['property_id'], "text"),
                       GetSQLValueString($_POST['Surname'], "text"),
                       GetSQLValueString($_POST['Firstname'], "text"),
                       GetSQLValueString($_POST['Phone_Number'], "text"),
                       GetSQLValueString($_POST['Cost_Naira'], "int"),
...
<div align="center">
  <table width="858" height="518" border="1" bgcolor="#FFFFFF">
    ...
    <tr>
      <td width="666" height="308"><h1>CHARGES</h1>
        <p>Charges accrued to purchase ofthe building type is specified here.</p>
        <form action="<?php echo $editFormAction; ?>" method="post" name="form2" id="form2">
          <table align="center">
            ...
            <tr valign="baseline">
              <td nowrap="nowrap" align="right">Cost (Naira):</td>
              <td><input type="text" name="Cost_Naira" value="" size="32" /></td>
            </tr>
            <tr valign="baseline">
...
<p>&nbsp;</p>
<p onmouseover="MM_validateForm('cost','','RisNum');return document.MM_returnValue">&nbsp;</p>
<p>&nbsp;</p>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        ...
        <p>&nbsp;</p>
      <p>&nbsp;</p></td>
      <td width="176" bgcolor="#0000FF" onmouseover="MM_validateForm('cost','','R');return document.MM_returnValue"><p><strong><font color="#FFFFFF">Our Objective</font></strong></p>
