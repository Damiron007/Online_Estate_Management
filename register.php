...
mysql_select_db($database_estatemgtdb, $estatemgtdb);
$query_Register = "SELECT * FROM register UNION SELECT * FROM users;";
$Register = mysql_query($query_Register, $estatemgtdb) or die(mysql_error());
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1" onsubmit="MM_validateForm('username','','R','password','','R','email','','RisEmail');return document.MM_returnValue">
  <p>NEW USER</p>
